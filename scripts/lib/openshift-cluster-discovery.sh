...
openshift_discover_run() {
  local apps_domain cluster_name quay_host kagenti_base git_url api_server
  ...
  export APPS_DOMAIN CLUSTER_NAME QUAY_REGISTRY_SERVER KAGENTI_API_BASE_URL GIT_REPO_URL API_SERVER
}
